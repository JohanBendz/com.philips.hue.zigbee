...
&nbsp;
var mainModule = (require.main &amp;&amp; path.dirname(require.main.filename) || <span class="branch-2 cbranch-no" title="branch not covered" >process.cwd())</span> + '/';
&nbsp;
...
&nbsp;
    fs.readFile(frame.filename, function (_err, file) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!_err) {
