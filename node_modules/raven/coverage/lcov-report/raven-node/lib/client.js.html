  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>186/237</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">73.44% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>94/128</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>185/233</span>
      </div>
    </div>
  </div>
...
464
465
466</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  captureQuery: <span class="fstat-no" title="function not covered" >function captureQuery(query, engine, kwargs, cb) {</span>
<span class="cstat-no" title="statement not covered" >    if (!cb &amp;&amp; typeof kwargs === 'function') {</span>
<span class="cstat-no" title="statement not covered" >      cb = kwargs;</span>
<span class="cstat-no" title="statement not covered" >      kwargs = {};</span>
    } else {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var eventId = this.generateEventId();</span>
<span class="cstat-no" title="statement not covered" >    this.process(eventId, parsers.parseQuery(query, engine, kwargs), cb);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return eventId;</span>
  },
&nbsp;
  ...
  context: function (ctx, func, onErr) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!func &amp;&amp; typeof ctx === 'function') {
      func = ctx;
      ctx = {};
    }
&nbsp;
...
&nbsp;
    var self = this;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof onErr !== 'function') {
      onErr = <span class="fstat-no" title="function not covered" >function (err) {</span>
<span class="cstat-no" title="statement not covered" >        self.captureException(err, wrapDomain.sentryContext);</span>
      };
    }
&nbsp;
...
&nbsp;
  getContext: <span class="fstat-no" title="function not covered" >function getContext() {</span>
<span class="cstat-no" title="statement not covered" >    return domain.active ? domain.active.sentryContext : this._globalContext;</span>
  },
&nbsp;
...
&nbsp;
  requestHandler: <span class="fstat-no" title="function not covered" >function () {</span>
...
<span class="cstat-no" title="statement not covered" >      self.context({}, next, next);</span>
    };
  },
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var kwargs = parsers.parseRequest(req);</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Nov 07 2016 15:46:49 GMT-0800 (PST)
</div>
</div>
